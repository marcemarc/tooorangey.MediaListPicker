/**
@ngdoc directive
@name umbraco.directives.directive:toooMediaList
@restrict E
@scope

@description
Use this directive to generate a thumbnail grid of media items with an option to switch to a 'list view' without images
...
(function () {
    ...
    function MediaListDirective($filter, mediaHelper) {
        ...
        //tell the directive to use our view that has the list view switch in
        var directive = {
            restrict: 'E',
            replace: true,
            templateUrl: '/app_plugins/tooorangey.MediaListPicker/tooo-media-list.html',
            scope: {
                items: '=',
                onDetailsHover: "=",
                onClick: '=',
    ...
    //register Media List directive
    angular.module('umbraco.directives').directive('toooMediaList', MediaListDirective);
